// MRI Simulator — Service Worker v37
// Optimised for Android Chrome PWA — cache-first app shell, persistent storage.

// SW VERSION: v37 — must match app version; bump CACHE name on every index.html change
const CACHE = 'mri-sim-v37';
...
const OPTIONAL_ASSETS = [
  ...
  // Data files — pre-cache so the app works fully offline from first launch.
  // Filenames must match data-manifest.json. Update these whenever you roll
  // a new calibration or planning file, and bump the CACHE version above.
  BASE + 'v3.json',
  BASE + 'mri_planning_2026-03-01.json',
];
